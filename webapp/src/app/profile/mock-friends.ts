...
export const FRIENDS: ProfileI[] = [
  ...
  { id: 13, name: 'Bombasto', lastname: 'Lastname', email: 'info@holidayz.earth', profilepic: '../../assets/red-marker.png'   },
  { id: 14, name: 'Celeritas', lastname: 'Lastname', email: 'info@holidayz.earth', profilepic: ''   },
  { id: 15, name: 'Magneta', lastname: 'Lastname', email: 'info@holidayz.earth', profilepic: ''   },
  { id: 16, name: 'Rubber', lastname: 'Man', email: 'info@holidayz.earth', profilepic: ''   },
  { id: 17, name: 'Dynama', lastname: 'Lastname', email: 'info@holidayz.earth', profilepic: '../../assets/background-1.jpg'   },
