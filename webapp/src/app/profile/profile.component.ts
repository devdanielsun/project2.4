...
export class ProfileComponent implements OnInit {
  ...
  constructor(private route: ActivatedRoute, private service: ProfileService, private router: Router, private mapService: MapService, private popupService: PopupService) {
